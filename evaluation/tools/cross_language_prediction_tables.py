...
if __name__ == '__main__':
        ...
        for prompt in prompts:
            for document_language in languages:
                for question_language in languages if document_language == 'de' else reversed(languages):
                    ...
                    full_document_language = 'Ger.' if document_language == 'de' else ('Eng.' if document_language == 'en' else 'Ara.')
                    full_question_language = 'Ger.' if question_language == 'de' else ('Eng.' if question_language == 'en' else 'Ara.')
                    ...
                    _means += evaluate(questions, predictions)[0][0:2]
                    _means += evaluate_no_answer(questions, predictions)[0:2]
                    means.append(_means)
    ...
    for index in range(len(means)):
        ...
        if index < len(means) - 1 and index % 3 == 2:
            answers_table.append('\\midrule')
